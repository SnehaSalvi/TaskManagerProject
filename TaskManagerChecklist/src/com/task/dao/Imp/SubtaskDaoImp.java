...
public class SubtaskDaoImp implements SubtaskDao 
{
	...
	private static final String GET_TaskItem = "select s.id,s.taskid,s.name,s.status from mytaskdatabase.task t, mytaskdatabase.subtask s where t.id=s.taskid and t.id=?";
